...
mod tests {
    ...
    async fn tests_solution_architect() {
        ...
        project_description :"Build a full stack website with user login and logout that shows latest Fortex prices".to_string(),
        project_scope:None,
        external_urls:None,
        backend_code:None,
        ...
        agent
            ...
            .await
            .expect("Unable to execlude Solution Architect Agent");
